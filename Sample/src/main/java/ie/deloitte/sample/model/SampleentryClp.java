...
public class SampleentryClp extends BaseModelImpl<Sampleentry>
    ...
    public void setName(String name) {
        ...
        if (_sampleentryRemoteModel != null) {
            try {
                ...
                method.invoke(_sampleentryRemoteModel, name);
            } catch (Exception e) {
                throw new UnsupportedOperationException(e);
            }
        }
    ...
    public void setMessage(String message) {
        ...
        if (_sampleentryRemoteModel != null) {
            try {
                ...
                method.invoke(_sampleentryRemoteModel, message);
            } catch (Exception e) {
                throw new UnsupportedOperationException(e);
            }
        }
    ...
    public void setEmail(String email) {
        ...
        if (_sampleentryRemoteModel != null) {
            try {
                ...
                method.invoke(_sampleentryRemoteModel, email);
            } catch (Exception e) {
                throw new UnsupportedOperationException(e);
            }
        }
    ...
    public void setGuestbookId(long guestbookId) {
        ...
        if (_sampleentryRemoteModel != null) {
            try {
                ...
                method.invoke(_sampleentryRemoteModel, guestbookId);
            } catch (Exception e) {
                throw new UnsupportedOperationException(e);
            }
        }
    ...
    public String toXmlString() {
        ...
        sb.append("ie.deloitte.sample.model.Sampleentry");
