 ...
 * @generated
 */
public class SamplebookLocalServiceClp implements SamplebookLocalService {
    ...
    public SamplebookLocalServiceClp(
    ...
    public ie.deloitte.sample.model.Samplebook addSamplebook(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(samplebook) });
        } catch (Throwable t) {
        ...
        return (ie.deloitte.sample.model.Samplebook) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<ie.deloitte.sample.model.Samplebook> getSamplebooks(
        ...
        return (java.util.List<ie.deloitte.sample.model.Samplebook>) ClpSerializer.translateOutput(returnObj);
    }
